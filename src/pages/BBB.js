  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="bbb-layout">
          <section>
            <div className="bbb-image-container">
              {/* 1st Button */}
              <a href="/mathematics" className="bbb-circle-button-1">
                <img
                  src={require("../assets/math.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-1"
                />
              </a>

              {/* 2nd Button */}
              <a href="/Physical_Sciences" className="bbb-circle-button-2">
                <img
                  src={require("../assets/ps.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-2"
                />
              </a>
              ...
              <a
                ...
                className="bbb-circle-button-3"
              >
                <img
                  src={require("../assets/ees.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-3"
                />
              </a>

              {/* 4th Button */}
              <a href="/Social_Sciences" className="bbb-circle-button-4">
                <img
                  src={require("../assets/ss.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-4"
                />
              </a>
              ...
              <a
                ...
                className="bbb-circle-button-5"
              >
                <img
                  src={require("../assets/ycs.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-5"
                />
              </a>
              ...
              <a
                ...
                className="bbb-circle-button-6"
              >
                <img
                  src={require("../assets/cls.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-6"
                />
              </a>

              {/* 7th Button */}
              <a href="/Health_Life_Sciences" className="bbb-circle-button-7">
                <img
                  src={require("../assets/hls.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-7"
                />
              </a>

              {/* 8th Button */}
              <a href="/Technological_Sciences" className="bbb-circle-button-8">
                <img
                  src={require("../assets/ts.png")}
                  alt="Go to Page"
                  className="bbb-circle-image-8"
                />
              </a>
            </div>
          </section>
