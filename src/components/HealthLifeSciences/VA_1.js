import va_front_page from "../../assets/health-life-sciences/va_front_page.png";
...
const VA_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Health_Life_Sciences/Veterinary_Ayurveda_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Health_Life_Sciences/Food_Science_Page")}
      >
        Next →
      </button>
    </main>
