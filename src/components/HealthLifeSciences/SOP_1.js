import sop_front_page from "../../assets/health-life-sciences/sop_front_page.png";
...
const SOP_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Health_Life_Sciences/Science_of_Pulse_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
