import bot_front_page from "../../assets/health-life-sciences/bot_front_page.png";
  ...
  return (
    <main>
      ...
      <button
        ...
        onClick={() => navigate("/Health_Life_Sciences/Horticulture_Floriculture_Page")}
      >
        Next →
      </button>
    </main>
