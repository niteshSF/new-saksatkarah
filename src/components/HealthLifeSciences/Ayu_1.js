import psy_front_page from "../../assets/health-life-sciences/ayu_front_page.png";
...
const Ayu_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Health_Life_Sciences/Ayurveda_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Health_Life_Sciences/Botany_Page")}
      >
        Next →
      </button>
    </main>
