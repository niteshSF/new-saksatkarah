import hf_front_page from "../../assets/health-life-sciences/hf_front_page.png";
...
const HF_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Health_Life_Sciences/Horticulture_Floriculture_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Health_Life_Sciences/Veterinary_Ayurveda_Page")}
      >
        Next →
      </button>
    </main>
