import algebra_front_page from "../../assets/mathematics/algebra_front_page.jpg";
...
const Algebra_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/mathematics/Algebra_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/mathematics/Geometry_Page")}
      >
        Next →
      </button>
    </main>
