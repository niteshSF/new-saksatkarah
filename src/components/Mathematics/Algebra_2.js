  ...
  return (
    <>
      <div>
                      ...
                      <ul className="submenu">
                        ...
                        <li>
                          ...
                          >
                            ...
                            Lal Singh Motilal Banarasi Dass Publishers Pvt.
                            Ltd., Delhi
                          </a>
                        </li>
                        ...
                        <li>
                          <a
                            ...
                            className="submenu-link"
                          >
                            Aryabhatiya of Aryabhata: 3 volumes By K. V. Sarma
                            and K. S. Shukla
                          </a>
                        </li>
                        <li>
        ...
        <main>
          <div
            className={`main-content-full ${isCollapsed ? "collapsed" : ""}`}
          >
            {!isCollapsed && (
              <section
            ...
            <section className="alge-mid-section">
              ...
              >
                ...
                Bhāratīya subcontinent, renowned for its rich heritage in
                various sciences, has been a cradle for the development of
                algebraic thought long before its versions emerged in the
                western world. The contributions of ancient Bhāratīya
                mathematicians to the field of algebra are profound and testify
                to the intellectual prowess and innovative spirit that
                characterized ancient Bhārata. Not only is this deep connection
                with mathematical thought evident, but it also enlightens us
                about the advanced mathematical understanding that permeated
                Bhāratīya culture from its earliest stages, as seen in the Vedic
                texts where numerical patterns and sophisticated calculations
                were employed in rituals and cosmology.
              </p>
            ...
            The Origins and Evolution of Algebra
              ...
              >
                <div style={{ flex: "1 1 50%", minWidth: "300px" }}>
                  ...
                  <p>
                    ...
                    which was introduced to the Western world through the works
                    of the ninth century Persian mathematician Al-Khwārizmī.
                    However, the foundational concepts of algebra can be traced
                    back to ancient Bhārata, where it was known as Bījagaṇita
                    (literally, “computation with seeds”). This term beautifully
                    captures the essence of algebra, where symbols and equations
                    are used to solve problems that are not immediately
                    apparent, much like seeds that contain the potential for
                    growth into something more significant. The term Bījagaṇita
                    signifies the practical application of algebra in multiple
                    domains, and reflects algebra's cultural and philosophical
                    significance in ancient Bhārata.
                  </p>
                  <p>
                    ...
                    Śulbasūtras, which are part of the Kalpasūtra texts and
                    dealt with geometric constructions of vedis (altars) for
                    religious rituals. While primarily focussed on geometry,
                    these texts also hinted at the understanding of linear and
                    quadratic equations, laying the groundwork for later
              ...
              >
                ...
                >
                  ...
                  <p>
                    One of the most significant figures in the history of
                    algebra is Bhāskarācārya, also known as Bhāskara II.
                    Bījagaṇita, which he authored, is one of the best-known
                    treatises on algebra. He discusses the general cakravāla
                    method for solving indeterminate equations of the second
                    degree. This method is indeed more optimal than the methods
                    discovered much later by Euler and Lagrange in Europe in the
                    18th century.
                  </p>
                </div>
                ...
                <div style={{ flex: "1 1 50%", minWidth: "300px" }}>
                  ...
                  <p>
                    ...
                    innovative approaches demonstrate a deep understanding of
                    the underlying principles, and are believed to have been key
                    in inspiring generations to come.
                  </p>
                  <p>
                    The algebraic techniques developed in ancient Bhārata were
                    not confined to abstract theory but were applied to solve
                    ...
                    integral values. This technique, which is developed further
                    in works like Bhāskarācārya's Bījagaṇita, showcases the
                    advanced level of mathematical thinking in ancient Bhārata.
                    The kuttaka method was later adapted and refined by other
                    mathematicians, including Brahmagupta, who expanded on it in
                    his Brāhmasphuṭasiddhānta.
                  </p>
                  <p>
                    ...
                    operations involving unknowns, rules for arithmetic
                    operations involving zero, and the concept of negative
                    numbers. His methods for solving quadratic equations were
                    particularly influential, and his work was later translated
                    into Arabic, influencing the development of algebra in the
                    Islamic world. Brahmagupta also discussed indeterminate
                    equations of second degree (vargaprakṛti) and discovered the
                    principle of bhāvanā or composition relating solutions of
                    this equation.
                  </p>
              ...
              <div style={{ minWidth: "300px", padding: "0.5rem" }}>
                ...
                <p>
                  ...
                  life. The mathematical texts were often written in verse,
                  making them accessible and easy to memorize. Most of the
                  well-known mathematical formulae, equations, results and
                  procedures were conveyed through such verses. This poetic
                  approach to mathematics reflects the broader Bhāratīya
                  tradition of integrating knowledge with art and culture, which
                  continues to influence our lives today, connecting us to our
                  rich heritage and inspiring us with the innovative spirit of
                  our ancestors.
                </p>
                <p>
                  The importance of algebra in ancient Bhārata can also be seen
                  in its application to various fields, including astronomy,
