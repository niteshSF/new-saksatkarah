import abj_front_page from "../../assets/social-science/abj_front_page.png";
...
const ABJ_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Social_Sciences/Ancient_Bhāratīya_Jurisprudence_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Social_Sciences/Trade_and_Commerce_Page")}
      >
        Next →
      </button>
    </main>
