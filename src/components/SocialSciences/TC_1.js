import tc_front_page from "../../assets/social-science/tc_front_page.png";
...
const TC_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Social_Sciences/Trade_and_Commerce_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Social_Sciences/Political_Science_Page")}
      >
        Next →
      </button>
    </main>
