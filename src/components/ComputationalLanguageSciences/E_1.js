import e_front_page from "../../assets/comp-lang-science/e_front_page.png";
...
const E_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Computational_Language_Sciences/Encryption_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Computational_Language_Sciences/Combinatorics_Mnemonics_Page")}
      >
        Next →
      </button>
    </main>
