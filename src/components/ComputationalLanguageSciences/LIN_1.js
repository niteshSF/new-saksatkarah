import lin_front_page from "../../assets/comp-lang-science/lin_front_page.png";
...
const LIN_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Computational_Language_Sciences/Linguistics_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Computational_Language_Sciences/Semantic_Analysis_Page")}
      >
        Next →
      </button>
    </main>
