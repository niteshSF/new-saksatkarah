import sa_front_page from "../../assets/comp-lang-science/sa_front_page.png";
...
const SA_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Computational_Language_Sciences/Semantic_Analysis_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Computational_Language_Sciences/Encryption_Page")}
      >
        Next →
      </button>
    </main>
