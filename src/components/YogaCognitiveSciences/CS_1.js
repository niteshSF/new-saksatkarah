import cs_front_page from "../../assets/yc-sciences/cs_front_page.png";
...
const CS_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Yoga_Cognitive_Sciences/Cognitive_Sciences_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Yoga_Cognitive_Sciences/Psychology_Mantras_Page")}
      >
        Next →
      </button>
    </main>
