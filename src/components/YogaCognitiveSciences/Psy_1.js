import psy_front_page from "../../assets/yc-sciences/psy_front_page.png";
...
const Psy_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Yoga_Cognitive_Sciences/Psychology_Mantras_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
