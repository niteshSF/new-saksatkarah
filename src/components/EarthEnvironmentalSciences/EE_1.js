import ee_front_page from "../../assets/ee-sciences/ee_front_page.png";
...
const EE_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Earth_Environmental_Sciences/Ecology_Environment_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Earth_Environmental_Sciences/Forestry_Page")}
      >
        Next →
      </button>
    </main>
