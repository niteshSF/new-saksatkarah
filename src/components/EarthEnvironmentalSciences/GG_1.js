import gg_front_page from "../../assets/ee-sciences/gg_front_page.png";
...
const GG_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Earth_Environmental_Sciences/Geology_Geography_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Earth_Environmental_Sciences/Ecology_Environment_Page")}
      >
        Next →
      </button>
    </main>
