import ca_front_page from "../../assets/physical-sciences/ca_front_page.png";
...
const CA_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Physical_Sciences/Cosmology&Astronomy_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Physical_Sciences/Physics_Page")}
      >
        Next →
      </button>
    </main>
