import agri_front_page from "../../assets/technology-science/agri_front_page.png";
...
const Agri_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Technological_Sciences/Agriculture_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Technological_Sciences/Water_Management_Page")}
      >
        Next →
      </button>
    </main>
