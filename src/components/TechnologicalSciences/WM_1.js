import wm_front_page from "../../assets/technology-science/wm_front_page.png";
...
const WM_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Technological_Sciences/Water_Management_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Technological_Sciences/Metallurgy_Page")}
      >
        Next →
      </button>
    </main>
