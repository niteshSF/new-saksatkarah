import meta_front_page from "../../assets/technology-science/te_front_page.png";
...
const TE_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Technological_Sciences/Textile_Engineering_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Technological_Sciences/Gemmology_Page")}
      >
        Next →
      </button>
    </main>
