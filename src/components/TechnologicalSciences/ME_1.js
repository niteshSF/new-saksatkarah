import meta_front_page from "../../assets/technology-science/me_front_page.png";
...
const ME_1 = () => {
  ...
  return (
    <main>
      ...
      <button
        onClick={() => navigate("/Technological_Sciences/Mechanical_Engineering_Content")}
        style={{
          position: "absolute",
          bottom: "2vh",
          right: "8vw",
      ...
      <button
        ...
        onClick={() => navigate("/Technological_Sciences/Textile_Engineering_Page")}
      >
        Next →
      </button>
    </main>
