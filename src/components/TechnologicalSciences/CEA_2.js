                  ...
                  {activeSubmenu === "primary" && (
                    <ul className="submenu">
                      <li>
                        ...
                        >
                          Vastu Sastra Vol.-i Hindu Science Of Architecture By
                          Shukla, D. N.
                        </a>
                      </li>
                      <li>
                    ...
                    <ul className="submenu">
                      <li>
                        <a
                          ...
                          className="submenu-link"
                        >
                          Principles Of Indian Silpasastra By Bose Phanindra
                          Nath
                        </a>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          Vol.2 By Acharya, Prasanna Kumar
                        </a>
                      </li>
                    </ul>
                  )}
          ...
          <section className="alge-mid-section">
            ...
            >
              ...
              <div style={{ flex: "1 1 50%", minWidth: "300px" }}>
                ...
                <p>
                  The Stone Chariot of Hampi, located in the Vijaya Vittala
                  Temple complex, is an extraordinary example of the
                  architectural and engineering prowess of Bharat, particularly
                  during the Vijayanagara Empire. This intricately carved
                  chariot, made entirely of stone, stands as a symbol of the
                  grandeur and creativity of the era. The chariot, which
                  resembles a mobile temple, is a stationary monument dedicated
                  to Garuḍa, the divine vehicle of Lord Viṣṇu. The precision
                  with which each stone block has been placed and the detailed
                  carvings that adorn the chariot reflect the advanced
                  understanding of mechanics and art that ancient Bhāratīya
                  artisans possessed, evoking a sense of wonder and appreciation
                  for their skills.
                </p>
                <p>
                  The construction of the Stone Chariot showcases the ingenuity
                  of ancient engineers who had the necessary tools to create a
                  structure that has withstood the test of time. Though
                  immovable, the chariot's wheels are carved to appear as if
                  they would roll any moment, symbolizing the universe's dynamic
                  nature. This monument is not just a work of art but also an
                  embodiment of the spiritual and cultural ethos of the time,
                  where every architectural element was infused with symbolic
                  meaning. The dynamic design of the wheels represents the
                  ever-changing nature of the universe, a concept deeply
                  ingrained in the spiritual beliefs of ancient Bharat.
                </p>
                <p>
                  The civil engineering and architectural feats of ancient
                  Bharat are a testimony to our people's ingenuity, creativity,
                  and spiritual depth. From the meticulously planned cities of
                  the Indus Valley Civilization to the majestic temples and
                  monuments of the Vijayanagara Empire, the legacy of Bhāratīya
                  engineers and architects inspires awe and admiration. These
                  structures were not merely functional but expressions of
                  cosmic order, designed to harmonize the physical and spiritual
                  worlds. Their enduring legacy continues to influence and
                  inspire modern engineering and architecture, reminding us of
                  the timeless wisdom and cultural richness of ancient Bharat.
                </p>
              </div>
            </div>
