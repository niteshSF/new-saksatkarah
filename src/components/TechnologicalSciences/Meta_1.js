import meta_front_page from "../../assets/technology-science/meta_front_page.png";
  ...
  return (
    <main>
      ...
      <button
        ...
        onClick={() => navigate("/Technological_Sciences/Civil_Engineering_Architecture_Page")}
      >
        Next →
      </button>
    </main>
